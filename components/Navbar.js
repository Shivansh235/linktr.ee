    ...
    <>{showNavbar && <nav className="bg-white fixed w-[80vw] z-50 top-10 right-[10vw] p-3 rounded-full">
      <div className="logo flex ml-4 items-center gap-20">
        ...
        <ul className="flex space-x-10">
          <Link  href={"/Template"}><li className="hover:bg-gray-100 p-1 rounded-lg cursor-pointer text-base">
            Templates
          </li></Link>
          <Link href={"/Marketplace"}><li className="hover:bg-gray-100 p-1 rounded-lg cursor-pointer text-base">
            Marketplace
          </li></Link>
          <Link href={"/discover"}><li className="hover:bg-gray-100 p-1 rounded-lg cursor-pointer text-base">
            Discover
          </li></Link>
          <Link href={"/pricing"}><li className="hover:bg-gray-100 p-1 rounded-lg cursor-pointer text-base">
            Pricing
          </li></Link>
          <Link href={"/learn"}><li className="hover:bg-gray-100 p-1 rounded-lg cursor-pointer text-base">
            Learn
          </li></Link>
        </ul>

      <div className="flex ml-52 gap-2">
        <Link href={'/Login'}><button className="bg-gray-300 p-4 rounded-lg hover:bg-gray-400 font-semibold">Log in</button></Link>
        <Link href={'/Login'}><button className="bg-black px-4 py-3 rounded-full mt-1 text-white ">Sign up free</button></Link>
      </div>
      </div>
